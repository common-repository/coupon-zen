<?php 
namespace couponZen\Admin;
/**
 * Recommended Plugins handlers class
 */
class Recommended_Plugins_call {
    ...
    public function plugin_recommendations(){ 
        $get_instance = Recommended_Plugins::instance( 
            array( 
                'text_domain'       => 'couponzen', 
                'parent_menu_slug'  => 'edit.php?post_type=couponzen', 
                'menu_capability'   => 'manage_options', 
                'menu_page_slug'    => 'couponzen-recommendations',
                'priority'          => 222,
                'assets_url'        => COUPONZEN_PL_URL.'admin/assets',
                'hook_suffix'       => 'couponzen_page_couponzen-recommendations'
            )
        );

        $get_instance->add_new_tab( array(

            'title' => esc_html__( 'Recommended', 'sirve' ),
            'active' => true,
            'plugins' => array(
